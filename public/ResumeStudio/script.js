    ...
    function updatePreview() {
        ...
        resumePreview.innerHTML = `
            ...
            <div class="resume-section">
                <h3>Summary</h3>
                <p>${summaryInput.value || "Professional summary will appear here."}</p>
            </div>

            <div class="resume-section">
                <h3>Projects</h3>
                <p>${projectsInput.value || "Your projects will appear here."}</p>
            </div>

            <div class="resume-section">
                <h3>Skills</h3>
                <p>${skillsInput.value || "Your skills will appear here."}</p>
            </div>

            <div class="resume-section">
                <h3>Experience</h3>
                <p>${experienceInput.value || "Your experience will appear here."}</p>
            </div>

            <div class="resume-section">
                <h3>Education</h3>
                <p>${educationInput.value || "Your education will appear here."}</p>
            </div>
        `;
